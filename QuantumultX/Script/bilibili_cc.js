...
# ～ 嗶哩嗶哩繁體CC字幕轉中文簡體（2022-08-09）
^https?:\/\/i.\.hdslb\.com\/bfs\/subtitle\/.+\.json$ url script-response-body https://raw.githubusercontent.com/KingsleyKing20/Assets/master/QuantumultX/Script/bilibili_cc.js
...
var kingsleyking = JSON.parse($response.body);

for (var i=0; i<kingsleyking.body.length;i++) kingsleyking.body[i].content = Simplized(kingsleyking.body[i].content);
