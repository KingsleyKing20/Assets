/*
脚本功能：哔哩哔哩签到-不投币
软件功能：登录/观看/分享/直播签到/银瓜子转硬币
更新时间：2022-10-31
使用平台：圈X, 其他平台未适配
脚本参考：Nobyda、Wyatt1026、ABreadTree、chavyleung感谢以上人员的开源奉献
使用方法：
    ①将[https://raw.githubusercontent.com/KingsleyKing20/Assets/master/QuantumultX/Script/BiliBili-GetCookie.js]添加远程重写。
    ②打开手机B站客户端，提示获取cookie成功,获取成功后关闭远程①的重写，直到cookie过期，再次使用①获取即可。
    ③将此脚本加到定时任务如[10 9 * * * https://raw.githubusercontent.com/KingsleyKing20/Assets/master/QuantumultX/Task/BiliBili-Daily.js, tag=B站每日等级任务, enabled=true]。
    ④等待定时任务执行，或手动执行。
    ⑤提示投币失败可尝试多次手动执行。
注意事项：
  抓取cookie时注意保证账号登录状态；
...
^https:\/\/app\.bilibili\.com\/x\/resource\/domain\? url script-request-header https://raw.githubusercontent.com/KingsleyKing20/Assets/master/QuantumultX/Task/BiliBili-Daily.js
