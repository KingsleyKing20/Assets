...
=========Surge=========
[Script]
小米运动 = type=cron,cronexp="15 17 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingsleyKing20/Assets/master/QuantumultX/Script/xiaomi.js
小米运动获取Token = type=http-response,pattern=^https:\/\/account\.huami\.com\/v2\/client\/login, requires-body=1, max-size=0, script-path=backUp/https://raw.githubusercontent.com/KingsleyKing20/Assets/master/QuantumultX/Script/xiaomi.js
=========QuantumultX=========
[task_local]
# 小米运动
15 17 * * * https://raw.githubusercontent.com/KingsleyKing20/Assets/master/QuantumultX/Script/xiaomi.js, tag=小米运动, img-url=https://qxnav.com/rules/QuantumultX/img/xiaomi.png
[rewrite_local]
# 小米运动获取Token
^https:\/\/account\.huami\.com\/v2\/client\/login url script-response-body https://raw.githubusercontent.com/KingsleyKing20/Assets/master/QuantumultX/Script/xiaomi.js
=========Loon=========
[Script]
cron "15 17 * * *" script-path=xmbs.js, tag=小米运动
http-response ^https:\/\/account\.huami\.com\/v2\/client\/login script-path=https://raw.githubusercontent.com/KingsleyKing20/Assets/master/QuantumultX/Script/xiaomi.js, requires-body=true, timeout=3600, tag=小米运动获取Token
 */
...
let login_token = '';
//需要修改的运动步数波动范围，脚本默认修改步数范围为1w到3w
